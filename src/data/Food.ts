export const Food = [
    ...
    'Darkmantle souffl�, with hollandaise sauce and a fried egg on top.',
    ...
    'Sauteed Partridge in a black raspberry reduction sauce, comes with a side of Grilled Jalape�os.',
